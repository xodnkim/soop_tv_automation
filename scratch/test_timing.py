...
def run_debug():
    ...
    time.sleep(2) # same as conftest.py
    ...
    print("Settings page loaded?", loaded)
    
    if not loaded:
        import base64
        res = driver.cdp.send("Page.captureScreenshot", {"format": "png"})
        if res and res.get("data"):
            with open("scratch/debug_timing.png", "wb") as f:
                f.write(base64.b64decode(res["data"]))
            print("Screenshot saved to scratch/debug_timing.png")
